            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                >
                  ...
                  <img src={addIcon} aria-hidden="true" className="h-6 w-6 " alt="add" />
                </button>
                ...
                <Menu as="div" className="relative ml-3">
                  ...
                  >
                    ...
                    <MenuItem>
                        <button onClick={handleLogout} className="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 focus:outline-none">
