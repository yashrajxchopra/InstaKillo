export default function ConfirmBox({handleSubmit, setIsConfirmOpen, loading, textToDisplay}) {
    return(
      ...
      <div className="fixed inset-0 bg-white dark:bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white dark:bg-black w-[200px] h-auto p-4 rounded-lg shadow-md flex flex-col items-center justify-between relative">
          <h3 className="text-black dark:text-white text-center font-medium">{textToDisplay}</h3>
